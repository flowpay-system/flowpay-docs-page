...
O acesso ao FlowPay App é exclusivo para contas aprovadas. O fluxo começa no cadastro externo e termina no login via link mágico.
...
> **[CONFIRMAR COM BACKEND: TTL do link mágico]** — informar aqui por quanto tempo o link permanece válido após o envio (ex: "O link expira em X minutos. Após esse prazo, solicite um novo link na tela de login.").
